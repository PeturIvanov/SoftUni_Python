...
class DirectorAdmin(CommonAdminMixin, admin.ModelAdmin):
    list_filter = ['years_of_experience']
    search_fields = ['full_name', 'nationality']


@admin.register(Actor)
class ActorAdmin(CommonAdminMixin, admin.ModelAdmin):
...
class MovieAdmin(admin.ModelAdmin):
    ...
    search_help_text = 'Search by director name or title!'
    readonly_fields = ['last_updated']
