...
# TEST CODE 02.THE STUDENT.
# keep the data from the previous exercise, so you can reuse it

# student1 = Student.objects.create(student_id="M1051",
#                                   first_name="Alice",
#                                   last_name="Johnson",
...
#                                   )
#
# student2 = Student.objects.create(student_id="S217",
#                                   first_name="Bob",
#                                   last_name="Smith",
